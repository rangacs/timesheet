	...
	<? foreach($hour as $row): ?>
    <?php echo form_open('dashboard/hours/edit'); ?>
	...
	<option value="<?= substr($row->start, 0, 2)?>" selected="selected"><?= substr($row->start, 0, 2)?></option>
	...
	<select name="start-minute" class="input-mini">
	    <option value="<?= substr($row->start, 3)?>" selected="selected"><?= substr($row->start, 3)?></option>
	...
	<option value="<?= substr($row->end, 0, 2)?>" selected="selected"><?= substr($row->end, 0, 2)?></option>
	<option value="07:">07</option>
	<option value="08:">08</option>
	<option value="09:">09</option>
	<option value="10:">10</option>
	...
	<select name="end-minute" class="input-mini">
	    <option value="<?= substr($row->end, 3)?>" selected="selected"><?= substr($row->end, 3)?></option>
	    <option value="00">00</option>
	    <option value="15">15</option>
	    <option value="30">30</option>
	    <option value="45">45</option>
